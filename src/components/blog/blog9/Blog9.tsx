...
const Blog9 = () => {
  ...
  const articleSchema = {
    ...
    keywords: `${category}, 아침 루틴, 라이프스타일`,
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta name="keywords" content={`${category}, 아침 루틴, 라이프스타일, ${title}`} />
        ...
        <meta property="article:tag" content="아침 루틴" />
        <meta property="article:tag" content="라이프스타일" />
