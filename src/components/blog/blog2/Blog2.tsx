...
const Blog2 = () => {
  ...
  const articleSchema = {
    ...
    keywords: `${category}, 쇼핑 가이드, 소비 가이드, 생활 꿀팁`,
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content={`${category}, 쇼핑 가이드, 소비 가이드, 생활 꿀팁, ${title}`} />
        ...
        <meta property="article:tag" content="쇼핑 가이드" />
        <meta property="article:tag" content="소비 가이드" />
                  ...
                  {articles
                    .filter(article => 
                      ...
                      (article.category === category || 
                       article.category.includes('소비') || 
                       article.category.includes('쇼핑') ||
