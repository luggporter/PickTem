...
const Blog6 = () => {
  ...
  const articleSchema = {
    ...
    keywords: `${category}, 계절 인테리어, 홈스타일링`,
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta name="keywords" content={`${category}, 계절 인테리어, 홈스타일링, ${title}`} />
        ...
        <meta property="article:tag" content="계절 인테리어" />
        <meta property="article:tag" content="홈스타일링" />
